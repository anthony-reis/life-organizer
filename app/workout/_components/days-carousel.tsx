// app/workout/_components/days-carousel.tsx
"use client";
...
export default function DaysCarousel({
  ...
  // Função para centralizar um dia
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between px-2">
        ...
        {!isTodaySelected && (
          <button
            onClick={goToToday}
            className="px-3 py-1.5 text-sm font-medium text-cyan-500 hover:bg-cyan-500/10 rounded-lg transition-colors"
          >
            Hoje
          </button>
        )}
            ...
            <button
              ...
              className={`flex-shrink-0 flex flex-col items-center justify-center w-14 h-16 rounded-2xl transition-all ${
                selected
                  ...
                  : todayCheck
                  ? "bg-cyan-500/10 text-cyan-600 border-2 border-cyan-500/20"
