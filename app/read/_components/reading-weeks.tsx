// app/read/_components/reading-weeks.tsx
"use client";
...
export default function ReadingWeeks({ plano }: { plano: PlanoItem[] }) {
  ...
  const [editandoLivro, setEditandoLivro] = useState<PlanoItem | null>(null);
              ...
              >
                ...
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => setEditandoLivro(item)}
                      className="p-2 rounded-lg text-gray-400 hover:text-cyan-500 hover:bg-cyan-500/10 transition-all"
                      title="Editar livro"
                    >
                ...
                {/* Seção de Anotação (visualização) */}
